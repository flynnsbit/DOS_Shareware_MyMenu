...
SCRIPT_URL="${URL}/flynnsbit/DOS_Shareware_MyMenu/blob/main/_mister/update/AO486_Update_Shareware_updater.sh"
...
# ini located at https://raw.githubusercontent.com/flynnsbit/DOS_Shareware_MyMenu/main/_mister/AO486_Update_Shareware_Pack.ini
